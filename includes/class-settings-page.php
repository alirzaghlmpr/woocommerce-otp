        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th>الزام تایید برای کاربران وارد شده</th>
                        <td>
                            <label>
                                <input type="checkbox"
                                    name="<?php echo esc_attr($this->option_name); ?>[checkout_verify_require_logged_in]"
                                    value="1" <?php checked($settings['checkout_verify_require_logged_in'] ?? false, 1); ?>>
                                کاربران وارد شده (Logged-in) هم باید شماره موبایل خود را تایید کنند
                            </label>
                            <p class="description">به‌طور پیش‌فرض (غیرفعال)، کاربرانی که از قبل وارد حساب کاربری خود شده‌اند از تایید شماره در تسویه‌حساب معاف هستند (چون حساب‌شان قبلاً احراز هویت شده) و این ویجت/پنجره برایشان نمایش داده نمی‌شود. اگر این گزینه را فعال کنید، کاربران وارد شده هم دقیقاً مثل مهمان‌ها ملزم به تایید شماره موبایل در تسویه‌حساب می‌شوند (بر اساس حالت انتخاب‌شده در بالا: داخل فرم یا قفل کامل).</p>
                        </td>
                    </tr>
                    <tr>
                        <th>رنگ دکمه‌ها و لینک‌ها</th>
                        <td>
                            <input type="color"
                                name="<?php echo esc_attr($this->option_name); ?>[checkout_verify_color]"
                                value="<?php echo esc_attr($settings['checkout_verify_color'] ?? '#2d264b'); ?>">
                            <p class="description">رنگ دکمه‌های «ارسال کد»/«تایید» و لینک «ارسال مجدد» در ویجت/مرحله تایید شماره موبایل در تسویه‌حساب.</p>
                        </td>
                    </tr>
